...
<style>
    ...
    :root {
        ...
        --violet-100:#F5EDE4;--violet-500:#B8956A;
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
    ...
    .stat-icon.blue svg { color:var(--amber-dark); }
    .stat-icon.teal { background:#ccfbf1; }
    .stat-icon.teal svg { color:var(--teal-500); }
    .stat-icon.violet { background:#E8DED4; }
    .stat-icon.violet svg { color:var(--brown-medium); }
